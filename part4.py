...
first_value= int(input("Enter a base for the triangle: "))
second_value= int(input("Enter a height for the triangle: "))
print("The area of the triangle is", (first_value * second_value)/2)